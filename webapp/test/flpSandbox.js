			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"laba1-display": {
								"semanticObject": "laba1",
								"action": "display",
								"description": "An SAP Fiori application for Laba 1.",
								"title": "Laba 1 Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=laba1",
									"url": sap.ui.require.toUrl("laba1")
								}
							}
						}
					}
